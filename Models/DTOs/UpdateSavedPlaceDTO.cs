...
{
    /// <summary>Payload for updating an existing saved favorite place.</summary>
    public class UpdateSavedPlaceDTO
    {
        /// <summary>Label or title for the saved place (e.g. "Home", "Work", "Gym").</summary>
